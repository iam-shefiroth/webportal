...
/* ユーザマスタのデータ（ADMIN権限） PASS:paswords */
...
INSERT INTO m_user (user_id, encrypted_password, user_name, darkmode, role, enabled)
VALUES('serious@xxx.co.jp', 'watashiwasefirosuda', 'セフィロス', true, 'ROLE_GENERAL', false);
...
INSERT INTO task (id, user_id, priority, title, comment, limitday) VALUES (6, 'serious@xxx.co.jp', 'MIDDLE','f', 'セフィロスごっこをする', '2022-07-22');